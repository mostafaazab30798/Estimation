-- Do not apply online ban when cleaning up players absent far longer than the reclaim window.
...
begin
  ...
  v_fresh_absence_cutoff := timezone('utc', now()) - v_reclaim_window - interval '90 seconds';
...
-- Clear expired bans when checking status.
