...
class BasraHomeScreen extends StatefulWidget {
  const BasraHomeScreen({super.key});

  @override
  State<BasraHomeScreen> createState() => _BasraHomeScreenState();
}
...
class _BasraHomeScreenState extends State<BasraHomeScreen>
  ...
  Future<void> _startBotGame(BuildContext context) async {
    ...
    final provider = context.read<GameProvider>();
    await provider.startBasraTestGame(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                const ModeHomeLandscapeDivider(accent: _gold),
                const SizedBox(width: 20),
                Expanded(
                  flex: 6,
  ...
  Widget _buildPrimaryAction(BuildContext context) {
    return ModeHomeActionButton(
      label: 'لعب فردي سريع',
      icon: AppIcons.bolt,
      gradient: const [_teal, Color(0xFF134E4A)],
      isLarge: true,
  ...
  Widget _buildMultiplayerGrid(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        const ModeHomeSectionLabel(text: 'العب مع الآخرين', accent: _gold),
  ...
  Future<void> _showBotSheet(BuildContext context) async {
    await showModeHomeSheet<void>(
      context,
      title: 'لعب فردي سريع',
      subtitle: 'اختر عدد اللاعبين (٢–٤)',
      accent: _teal,
      ...
      child: Column(
        ...
        children: [
          const SizedBox(
            width: 44,
            height: 44,
            child: CircularProgressIndicator(color: _gold, strokeWidth: 3.5),
          ),
          const SizedBox(height: 16),
          Text(
